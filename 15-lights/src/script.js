...
const directionalLight = new THREE.DirectionalLight(0x00fff3, 0.3)
...
gui.add(rectAreaLight, 'intensity').min(0).max(2).step(0.01)
gui.add(rectAreaLight, 'width').min(0).max(5).step(0.01)
gui.add(rectAreaLight, 'height').min(0).max(5).step(0.01)
...
gui.add(spotLight, 'angle').min(0).max(2).step(0.01)
